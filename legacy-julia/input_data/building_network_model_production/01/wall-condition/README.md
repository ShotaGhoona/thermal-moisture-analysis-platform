...
各パターンとも1壁で構成（計算効率化のため統合）:

| 壁番号 | 面積 | ION（傾斜角） | 備考 |
|--------|------|--------------|------|
| 1 | 100.0 m² | 90° (垂直) | 6面分を統合 |

※ 日射吸収率(ar_IP)=0のため、方位・傾斜角による日射影響なし。日射・結露水流れは本計算では重要でないため1壁に統合。
...
| area | m2 | 100.0 | 100.0 | 100.0 | 100.0 | 100.0 |
| ION | 度 | 90 | 90 | 90 | 90 | 90 |
| alphac_IP | W/m2K | 19 | 19 | 19 | 19 | 19 |
