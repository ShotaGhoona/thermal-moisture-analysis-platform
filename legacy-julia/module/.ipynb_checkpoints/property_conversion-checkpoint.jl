...
# 材料物性データのロード
include(string("./module_material_property/bentheimer_sandstone.jl"))
include(string("./module_material_property/benchmark_EN15026.jl"))
include(string("./module_material_property/tuff_motomachi.jl"))
include(string("./module_material_property/tuff_motomachi_v2.jl"))
include(string("./module_material_property/tuff_motomachi_v3.jl"))
include(string("./module_material_property/loamy_sand.jl"))
include(string("./module_material_property/plainfield_sand.jl"))
include(string("./module_material_property/sandy_clay_loam.jl"))
include(string("./module_material_property/mud_wall.jl"))
include(string("./module_material_property/plywood.jl"))
...
prop_list["sandy_clay_loam"] = sandy_clay_roam
