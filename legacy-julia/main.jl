...
2. julia main.jl または julia legacy-julia/main.jl で実行
=#
...
const OUTPUT_BASE_DIR = "output_data"               # 出力ベースディレクトリ（SCRIPT_DIRからの相対パス）
