...
|  | O1 | O2 | O3 | O4 | O5 |
|--|----|----|----|----|-----|
| W1 | ✅ (約1日不足) | ✅ (約1日不足) | ✅ (約1日不足) | ✅ (約1日不足) | ✅ (約1日不足) |
| W2 | ✅ (run03) | ✅ (run03) | ✅ (run03) | ✅ (run03) | ✅ (run03) |
| W3 | - | - | - | - | - |
| W4 | ✅ (run04, 約1日不足) | ✅ (run04, 約1日不足) | ✅ (run04, 約1日不足) | ✅ (run04, 約1日不足) | ❌ (run04:1ヶ月不足) |
| W5 | ✅ (run05) | ✅ (run05) | ✅ (run05) | ✅ (run05) | ✅ (run05) |
...
|  | O1 | O2 | O3 | O4 | O5 |
|--|----|----|----|----|-----|
| W1 | ✅ (run01) | ✅ (run01) | ✅ (run01) | ✅ (run01) | ✅ (run01) |
